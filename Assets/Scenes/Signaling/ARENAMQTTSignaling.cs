...
namespace ArenaUnity.HybridRendering.Signaling
{
    public class ARENAMQTTSignaling : ArenaMqttClient, ISignaling
    {
        ...
        private string SERVER_OFFER_TOPIC_PREFIX = "realm/g/a/cloud_rendering_sagar/server/offer";
        private string SERVER_ANSWER_TOPIC_PREFIX = "realm/g/a/cloud_rendering_sagar/server/answer";
        private string SERVER_CANDIDATE_TOPIC_PREFIX = "realm/g/a/cloud_rendering_sagar/server/candidate";
        private string SERVER_HEALTH_CHECK = "realm/g/a/cloud_rendering_sagar/server/health";
        private string SERVER_STATS_TOPIC = "realm/g/a/cloud_rendering_sagar/server/stats";

        private string CLIENT_CONNECT_TOPIC_PREFIX = "realm/g/a/cloud_rendering_sagar/client/connect";
        private string CLIENT_DISCONNECT_TOPIC_PREFIX = "realm/g/a/cloud_rendering_sagar/client/disconnect";
        private string CLIENT_OFFER_TOPIC_PREFIX = "realm/g/a/cloud_rendering_sagar/client/offer";
        private string CLIENT_ANSWER_TOPIC_PREFIX = "realm/g/a/cloud_rendering_sagar/client/answer";
        private string CLIENT_CANDIDATE_TOPIC_PREFIX = "realm/g/a/cloud_rendering_sagar/client/candidate";
        private string CLIENT_STATS_TOPIC_PREFIX = "realm/g/a/cloud_rendering_sagar/client/stats";

        private string UPDATE_REMOTE_STATUS_TOPIC_PREFIX = "realm/g/a/cloud_rendering_sagar/client/remote";
